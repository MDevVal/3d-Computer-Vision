...
protected:
  ...
  void
  keyPressEvent(QKeyEvent *event) Q_DECL_OVERRIDE; // handles key-press   events
  void keyReleaseEvent(QKeyEvent *event)
      Q_DECL_OVERRIDE; // handles key-release events
  void wheelEvent(QWheelEvent *event) Q_DECL_OVERRIDE; // handles wheel events
  void mouseMoveEvent(QMouseEvent *event)
      Q_DECL_OVERRIDE; // handles mouse-move  events
