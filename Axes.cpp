...
Axes::Axes(const QVector4D &_origin, const QMatrix4x4 &_rotation)
    : rotation(_rotation), origin(_origin) {
...
void Axes::draw(const RenderCamera &renderer, const QColor &color,
